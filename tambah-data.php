...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$handle = $pdo->prepare('INSERT INTO grupc (tim, menang, seri, kalah, point) 
        VALUES (:tim, :menang, :seri, :kalah, :point )');
		...
		$sukses = "Data <strong>{$tim}</strong> berhasil dimasukkan.";
		$id_grup = $pdo->lastInsertId();	
      ...
      <div id="content">
        ...
        <div class="card mb-10">
            ...
            <div class="card-body">
                Klik Tombol "Tinjau" untuk kembali ke halaman utama
						...
						<div class="card-body">
              <a href="grupc.php"><button class="btn btn-primary">Tinjau</button></a> 
            </div>
        </div>
        ...
        <form action="tambah-data.php" method="post">
            ...
            <table>
                  <td>
                      <td colspan="1">
                          <td><a href="tambah-data.php"><button type="submit" name="submit" value="submit" class="btn btn-success">Tambah Data</button></td>
                      </td>
                  </td>                       
            </table>
		</form>
