...
<head>
  ...
  <title>Ulangan Akhir Semester</title>
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span>Klasmen Eropa</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Data :</h6>
            <a class="collapse-item" href="#">Data Group C</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <div class="sidebar-brand-text mx-2"><h5>Klasmen Eropa Group C</h5></div>
        ...
        <div class="container-fluid">
          ...
          <span>Data Group C <br><?php echo date("l, d F Y, H:i:s")."<br/>"; ?></span>
          <php $startTime = date ("Ymd H:i:s"); ?>
          </div>
          <?php
            $query = $pdo->prepare('SELECT * FROM grupc');			
            $query->execute();
              ...
              <tbody>
                <?php while($hasil = $query->fetch()): ?>
                  <tr>
                    ...
                    <td><?php echo $hasil['menang']; ?></td>	
                    <td><?php echo $hasil['seri']; ?></td>							
                    <td><?php echo $hasil['kalah']; ?></td>	
                    <td><?php echo $hasil['point']; ?></td>							
                    
                    <td><a href="edit-data.php?id=<?php echo $hasil['tim']; ?>"><button class="btn btn-primary">Edit</button></a></td>
                    <td><a href="hapus-data.php?id=<?php echo $hasil['tim']; ?>"><button class="btn btn-danger">Hapus</button></a></td>
                      ...
                      <td>
                        <td>
                          <td>
                            <td>
                                <td colspan="1">
                                    <td><a href="tambah-data.php"><button class="btn btn-success">Tambah</button></td>
                                </td>
                            </td>
                          </td>
                        </td>
